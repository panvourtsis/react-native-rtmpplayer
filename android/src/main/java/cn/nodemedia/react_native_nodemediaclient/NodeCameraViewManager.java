...
public class NodePlayerViewManager extends SimpleViewManager<RCTNodePlayerView> {
    private RCTNodePlayerView view;
    ...
    @Override
    public RCTNodePlayerView createViewInstance(ThemedReactContext reactContext) {
        return view;
    }

    public RCTNodePlayerView getNodePlayerView() {
        return view;
    }
    ...
    @ReactProp(name = "hwEnable")
    public void setHWEnable(RCTNodePlayerView view, Boolean hwEnable) {
        view.setHWEnable(hwEnable);
    }
